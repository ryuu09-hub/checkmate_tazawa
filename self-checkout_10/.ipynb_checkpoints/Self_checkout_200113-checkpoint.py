...
if __name__ == '__main__':
    ...
    self_model = load_model('mobilenetv2.h5')
    ...
    # 正解ラベル
    label =  ['Azumino', 'Arupusu','Arupusu500', 'coffee', 'craft', 'tea']
    # 商品価格
    money = {'Azumino':110, 'Arupusu':120, 'Arupusu500':130, 'coffee':140,
             'craft':150, 'tea':80}
    ...
    while True:
        ...
        while True:
            ...
            if process_time >=2.0:
                print('処理時間がかかり過ぎます。(処理時間：{:.3f}秒)'.format(process_time))
                continue
            print("debug:",img_pred)
            
            if np.max(img_pred) < 0.90:
                print('商品をもう一度スキャンしてください。')
                continue
